...
func (qe *VmStop) Event() int 				 { return EVENT_VM_STOP }
...
func (qe *ListenPodCommand) Event() int 	 { return COMMAND_LISTEN_POD }
...
func (qe *MigratePodCommand) Event() int 	 { return COMMAND_MIGRATE_POD}
